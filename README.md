...
<h5>
Repositório para Exercício do curso do Youtube  **Angular 17**. O objetivo deste exercícios para futuro projeto de Front-end e Back-end de migração de sistema próprio.
</h5>
## 📋 Requisitos
